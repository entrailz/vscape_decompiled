...
public final class Rasterizer3D extends Rasterizer2D
{
    ...
    static {
        uwotm8.Rasterizer3D.a = true;
        uwotm8.Rasterizer3D.c = true;
        uwotm8.Rasterizer3D.u = new IndexedImage[51];
        uwotm8.Rasterizer3D.B = new boolean[51];
        uwotm8.Rasterizer3D.C = new int[51];
        uwotm8.Rasterizer3D.F = new int[51][];
        uwotm8.Rasterizer3D.v = new int[51];
        uwotm8.Rasterizer3D.x = new int[65536];
        uwotm8.Rasterizer3D.G = new int[51][];
        uwotm8.Rasterizer3D.z = new int[512];
        q = new int[2048];
        uwotm8.Rasterizer3D.r = new int[2048];
        uwotm8.Rasterizer3D.s = new int[2048];
        for (int i = 1; i < 512; ++i) {
            uwotm8.Rasterizer3D.z[i] = 32768 / i;
        }
        for (int j = 1; j < 2048; ++j) {
            uwotm8.Rasterizer3D.q[j] = 65536 / j;
        }
        for (int k = 0; k < 2048; ++k) {
            uwotm8.Rasterizer3D.r[k] = (int)(65536.0 * Math.sin(k * 0.0030679615));
            uwotm8.Rasterizer3D.s[k] = (int)(65536.0 * Math.cos(k * 0.0030679615));
        }
    }
    
    public static void a() {
        uwotm8.Rasterizer3D.z = null;
        uwotm8.Rasterizer3D.z = null;
        uwotm8.Rasterizer3D.r = null;
        uwotm8.Rasterizer3D.s = null;
        uwotm8.Rasterizer3D.t = null;
        uwotm8.Rasterizer3D.u = null;
        uwotm8.Rasterizer3D.B = null;
        uwotm8.Rasterizer3D.C = null;
        uwotm8.Rasterizer3D.E = null;
        uwotm8.Rasterizer3D.F = null;
        uwotm8.Rasterizer3D.v = null;
        uwotm8.Rasterizer3D.x = null;
        uwotm8.Rasterizer3D.G = null;
    }
    ...
    public static void a(final int n, final int n2) {
        uwotm8.Rasterizer3D.t = new int[n2];
        for (int i = 0; i < n2; ++i) {
            uwotm8.Rasterizer3D.t[i] = n * i;
        }
        uwotm8.Rasterizer3D.e = n / 2;
        uwotm8.Rasterizer3D.p = n2 / 2;
    }
    
    public static void c() {
        uwotm8.Rasterizer3D.E = null;
        for (int i = 0; i < 51; ++i) {
            uwotm8.Rasterizer3D.F[i] = null;
        }
    }
    
    public static void d() {
        if (uwotm8.Rasterizer3D.E == null) {
            uwotm8.Rasterizer3D.D = 20;
            if (uwotm8.Rasterizer3D.a) {
                uwotm8.Rasterizer3D.E = new int[uwotm8.Rasterizer3D.D][16384];
            }
            else {
                uwotm8.Rasterizer3D.E = new int[uwotm8.Rasterizer3D.D][65536];
            }
            for (int i = 0; i < 51; ++i) {
                uwotm8.Rasterizer3D.F[i] = null;
            }
    ...
    public static void unpackTextures(final Archive g) {
        ...
        for (int i = 0; i < 51; ++i) {
            try {
                uwotm8.Rasterizer3D.u[i] = new IndexedImage(g, String.valueOf(i), 0);
                if (uwotm8.Rasterizer3D.a && uwotm8.Rasterizer3D.u[i].e == 128) {
                    uwotm8.Rasterizer3D.u[i].a();
                }
                else {
                    uwotm8.Rasterizer3D.u[i].b();
                }
    ...
    public static int a(final int n) {
        if (uwotm8.Rasterizer3D.C[n] != 0) {
            return uwotm8.Rasterizer3D.C[n];
        }
        int n2 = 0;
        int n3 = 0;
        int n4 = 0;
        final int length = uwotm8.Rasterizer3D.G[n].length;
        for (int i = 0; i < length; ++i) {
            n2 += (uwotm8.Rasterizer3D.G[n][i] >> 16 & 0xFF);
            n3 += (uwotm8.Rasterizer3D.G[n][i] >> 8 & 0xFF);
    ...
    public static void b(final int n) {
        if (uwotm8.Rasterizer3D.F[n] == null) {
            return;
        }
        uwotm8.Rasterizer3D.E[uwotm8.Rasterizer3D.D++] = uwotm8.Rasterizer3D.F[n];
    ...
    public static void calculatePallette(double n) {
        ...
        for (int k = 0; k < 51; ++k) {
            if (uwotm8.Rasterizer3D.u[k] != null) {
    ...
    private static void drawShadedLine(final int[] array, int n, int n2, int n3, int n4, int n5) {
        if (uwotm8.Rasterizer3D.c) {
            ...
            if (uwotm8.Rasterizer3D.b) {
                ...
                if (n3 > uwotm8.Rasterizer2D.m) {
                    n3 = uwotm8.Rasterizer2D.m;
                }
                if (n2 < 0) {
                    n4 -= n2 * n6;
                    n2 = 0;
                ...
                n += n2;
                if ((n7 = n3 - n2 >> 2) > 0) {
                    n8 = (n5 - n4) * uwotm8.Rasterizer3D.z[n7] >> 15;
                }
                else {
                    n8 = 0;
                }
            }
            if (uwotm8.Rasterizer3D.d == 0) {
                while (--n7 >= 0) {
                    n5 = uwotm8.Rasterizer3D.x[n4 >> 8];
                    n4 += n8;
                    array[n++] = n5;
                    array[n++] = n5;
                    array[n++] = n5;
                ...
                final int d = uwotm8.Rasterizer3D.d;
                final int n10 = 256 - uwotm8.Rasterizer3D.d;
                while (--n7 >= 0) {
                    n5 = uwotm8.Rasterizer3D.x[n4 >> 8];
                    n4 += n8;
                ...
                int n11;
                if ((n11 = (n3 - n2 & 0x3)) > 0) {
                    n5 = (((n5 = uwotm8.Rasterizer3D.x[n4 >> 8]) & 0xFF00FF) * n10 >> 8 & 0xFF00FF) + ((n5 & 0xFF00) * n10 >> 8 & 0xFF00);
                    do {
                        array[n++] = n5 + ((array[n] & 0xFF00FF) * d >> 8 & 0xFF00FF) + ((array[n] & 0xFF00) * d >> 8 & 0xFF00);
                    } while (--n11 > 0);
                }
        ...
        if (uwotm8.Rasterizer3D.d == 0) {
            do {
                array[n++] = uwotm8.Rasterizer3D.x[n4 >> 8];
                n4 += n12;
            } while (--n13 > 0);
            return;
        }
        final int d2 = uwotm8.Rasterizer3D.d;
        final int n14 = 256 - uwotm8.Rasterizer3D.d;
        do {
            n5 = uwotm8.Rasterizer3D.x[n4 >> 8];
            n4 += n12;
    ...
    private static void drawScanLine(final int[] array, int n, int n2, int n3, int m) {
        ...
        final int d = uwotm8.Rasterizer3D.d;
        final int n6 = 256 - uwotm8.Rasterizer3D.d;
    ...
    public static void drawTexturedTriangle(int n, int n2, int n3, int n4, int n5, int n6, int n7, int n8, int n9, int n10, int n11, int n12, int n13, int n14, int n15, int n16, int n17, int n18, int n19) {
        ...
        n = n20;
        final int n38 = n19;
        uwotm8.Rasterizer3D.v[n38] = uwotm8.Rasterizer3D.w++;
        int[] array;
        if (uwotm8.Rasterizer3D.F[n38] != null) {
            array = uwotm8.Rasterizer3D.F[n38];
        }
        else {
            int[] array2;
            if (uwotm8.Rasterizer3D.D > 0) {
                array2 = uwotm8.Rasterizer3D.E[--uwotm8.Rasterizer3D.D];
                uwotm8.Rasterizer3D.E[uwotm8.Rasterizer3D.D] = null;
            }
            else {
                int n39 = 0;
                int n40 = -1;
                for (int i = 0; i < uwotm8.Rasterizer3D.A; ++i) {
                    if (uwotm8.Rasterizer3D.F[i] != null && (uwotm8.Rasterizer3D.v[i] < n39 || n40 == -1)) {
                        n39 = uwotm8.Rasterizer3D.v[i];
                        n40 = i;
                    }
                }
                array2 = uwotm8.Rasterizer3D.F[n40];
                uwotm8.Rasterizer3D.F[n40] = null;
            }
            uwotm8.Rasterizer3D.F[n38] = array2;
            final IndexedImage k = uwotm8.Rasterizer3D.u[n38];
            final int[] array3 = uwotm8.Rasterizer3D.G[n38];
            if (uwotm8.Rasterizer3D.a) {
                uwotm8.Rasterizer3D.B[n38] = false;
                for (int j = 0; j < 4096; ++j) {
                    ...
                    final int n43;
                    if ((n43 = n42) == 0) {
                        uwotm8.Rasterizer3D.B[n38] = true;
                    }
        ...
        uwotm8.Rasterizer3D.y = !uwotm8.Rasterizer3D.B[n19];
        n11 = n10 - n11;
        n14 = n13 - n14;
        n17 = n16 - n17;
        n12 -= n10;
        ...
        if (n <= n2 && n <= n3) {
            if (n < uwotm8.Rasterizer2D.clipTop) {
                ...
                if (n2 < n3) {
                    ...
                    final int n66 = n - uwotm8.Rasterizer3D.p;
                    n19 += n62 * n66;
                    int n67 = n63 + n10 * n66;
                    n16 += n11 * n66;
                    ...
                    final int n68 = n - uwotm8.Rasterizer3D.p;
                    n19 += n62 * n68;
                    int n69 = n63 + n10 * n68;
                    n16 += n11 * n68;
            ...
            if (n2 < uwotm8.Rasterizer2D.clipTop) {
                ...
                if (n3 < n) {
                    ...
                    final int n70 = n2 - uwotm8.Rasterizer3D.p;
                    n19 += n62 * n70;
                    int n71 = n63 + n10 * n70;
                    n16 += n11 * n70;
                    ...
                    final int n72 = n2 - uwotm8.Rasterizer3D.p;
                    n19 += n62 * n72;
                    int n73 = n63 + n10 * n72;
                    n16 += n11 * n72;
                    if (n12 < n17) {
            ...
            if (n < n2) {
                ...
                final int n74 = n3 - uwotm8.Rasterizer3D.p;
                n19 += n62 * n74;
                int n75 = n63 + n10 * n74;
                n16 += n11 * n74;
                if (n17 < n64) {
                ...
                final int n76 = n3 - uwotm8.Rasterizer3D.p;
                n19 += n62 * n76;
                int n77 = n63 + n10 * n76;
                n16 += n11 * n76;
                if (n17 < n64) {
    ...
    private static void drawTexuredLine(final int[] array, final int[] array2, int n, int n2, int m, int n3, int n4, int n5, int n6, int n7, final int n8, final int n9, final int n10) {
        ...
        if (uwotm8.Rasterizer3D.b) {
            ...
            n13 = m - n2 >> 3;
            n4 = (n4 - n3) * uwotm8.Rasterizer3D.z[n13] >> 6;
        }
        else {
            n13 = 0;
            n4 = 0;
        ...
        if (uwotm8.Rasterizer3D.a) {
            int n14 = 0;
            int n15 = 0;
            final int n16 = n2 - uwotm8.Rasterizer3D.e;
            n5 += (n8 >> 3) * n16;
            n6 += (n9 >> 3) * n16;
            final int n17;
            ...
            int n62 = 0;
            int n63 = 0;
            final int n64 = n2 - uwotm8.Rasterizer3D.e;
            n5 += (n8 >> 3) * n64;
            n6 += (n9 >> 3) * n64;
            final int n65;
