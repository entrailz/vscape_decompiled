...
public final class I_1 extends N_1
{
    public byte[] a;
    public int b;
    public int c;
    ...
    public final int i(int i) {
        ...
        this.c += i;
        while (i > n2) {
            n3 += (this.a[n++] & I_1.e[n2]) << i - n2;
            i -= n2;
            n2 = 8;
        }
        int n4;
        if (i == n2) {
            n4 = n3 + (this.a[n] & I_1.e[n2]);
        }
        else {
            n4 = n3 + (this.a[n] >> n2 - i & I_1.e[i]);
        }
        return n4;
    }
    ...
    public final void r() {
        ...
        this.a(b, 0, array);
        final byte[] byteArray = new BigInteger(array).modPow(ax.b, ax.a).toByteArray();
        this.b = 0;
