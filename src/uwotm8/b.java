...
public final class b {
   private static final a_1 a = new a_1();
   ...
   public static int a(byte[] var0, int var1, byte[] var2, int var3, int var4) {
      ...
      synchronized(a) {
         ...
         Object var6 = null;
         var18.p = 1;
         if (uwotm8.a_1.x == null) {
            uwotm8.a_1.x = new int[var18.p * 100000];
         }
            ...
            while(true) {
               while(var11 != var7) {
                  ...
                  if (var11 != 0 && var11 != 1) {
                     ...
                     uwotm8.a_1.x[var34] = var18.B[var41 & 255] & 255;
                     ++var34;
                     if (var32 == 0) {
                        ++var31;
                        var32 = 50;
               ...
               for(var11 = 0; var11 < var34; ++var11) {
                  var12 = (byte)uwotm8.a_1.x[var11];
                  uwotm8.a_1.x[var18.w[var12 & 255]] |= var11 << 8;
                  ++var18.w[var12 & 255];
               }

               var18.s = uwotm8.a_1.x[var18.r] >> 8;
               var18.v = 0;
               var18.s = uwotm8.a_1.x[var18.s];
   ...
   private static int a(int var0, a_1 var1) {
      while(var1.o < var0) {
