...
public final class Sprite extends p implements Cloneable
{
    private String p;
    public int[] a;
    public int b;
    ...
    public Sprite(final int n, final int n2) {
        this.p = String.valueOf(al.a()) + "sprites/";
        this.a = new int[n * n2];
        this.d = n;
        this.b = n;
        this.e = n2;
    ...
    public final void a(int k, int i, int n) {
        ...
        if (k + b > uwotm8.p.l) {
            final int n8 = k + b - uwotm8.p.l;
            b -= n8;
            n5 += n8;
            n4 += n8;
        }
        if (b > 0 && c > 0) {
            this.a(b, c, this.a, uwotm8.p.f, n2, n, n3, n5, n4);
        }
    }
    ...
    public Sprite(final G_1 g, final String s, int i) {
        this.p = String.valueOf(al.a()) + "sprites/";
        final I_1 j = new I_1(g.b(String.valueOf(s) + ".dat"));
        final I_1 k;
        (k = new I_1(g.b("index.dat"))).b = j.g();
        this.d = k.g();
        this.e = k.g();
        final int e;
    ...
    public final void d(int k, int i) {
        ...
        if (b > 0 && c > 0) {
            a(uwotm8.p.f, this.a, n2, n, b, c, n3, n4);
        }
    }
    ...
    public final void c(int k, int i, int n) {
        ...
        k += this.q;
        i += this.r;
        int n6 = k + i * uwotm8.p.g;
        int n7 = 0;
        n = n3;
        int n8 = n2;
        int n9 = uwotm8.p.g - n8;
        int n10 = 0;
        if (i < uwotm8.p.i) {
            final int n11 = uwotm8.p.i - i;
            n -= n11;
            i = uwotm8.p.i;
            n7 = 0 + n11 * n8;
            n6 += n11 * uwotm8.p.g;
        ...
        if (k + n8 > uwotm8.p.l) {
            final int n13 = k + n8 - uwotm8.p.l;
            n8 -= n13;
            n10 += n13;
            n9 += n13;
        }
        if (n8 > 0 && n > 0) {
            a(uwotm8.p.f, array, n7, n6, n8, n, n9, n10);
        }
    }
    ...
    public final void a(final int n, int n2, final int[] array, int n3, final int[] array2, int n4, int i, int j, int n5, int n6) {
        try {
            ...
            for (i = 0; i < n; ++i) {
                ...
                n11 = n4 - n9 * j;
                for (j = -array[i]; j < 0; ++j) {
                    uwotm8.p.f[n6++] = this.a[(n10 >> 16) + (n11 >> 16) * this.b];
                    n10 += n2;
                    n11 -= n9;
                }
                n3 += n9;
