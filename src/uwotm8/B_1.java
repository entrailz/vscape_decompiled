...
public final class B_1 extends A
{
    private int b;
    private final int[] c;
    private final int d;
    ...
    private j b() {
        ...
        if (this.d != -1) {
            try {
                ...
                final int c = aj.c;
                n = (B_1.a.A[b] >> c & Client.ad[aj.d - c]);
            }
            catch (Exception ex) {}
        }
        else if (this.e != -1) {
    ...
    public B_1(final int l, final int n, final int m, final int g, final int h, final int f, final int i, final int n2, final boolean b) {
        this.l = l;
        this.m = m;
        this.n = n;
        this.f = f;
