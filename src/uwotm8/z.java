...
public final class z extends A
{
    ...
    public final D_1 a() {
        ...
        final int x = this.x;
        final D_1 d3 = d2;
        final int n2 = D_1.D[x];
        final int n3 = D_1.E[x];
    ...
    public z(final int s, final int c, final int a, final int b, final int t, final int i, final int r, final int q, final int p11, final int g, final int n) {
        this.o = false;
        this.u = uwotm8.g.a[n];
        this.i = i;
        this.p = p11;
