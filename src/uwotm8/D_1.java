...
public final class D_1 extends A {
   ...
   private D_1(int var1) {
      ...
      if ((var2 = Z[var1].a)[var2.length - 1] == -1 && var2[var2.length - 2] == -1) {
         var169 = this;
         I_1 var172 = new I_1(var2);
         var6 = new I_1(var2);
         var7 = new I_1(var2);
         var8 = new I_1(var2);
         var9 = new I_1(var2);
         var10 = new I_1(var2);
         I_1 var173 = new I_1(var2);
         ...
         if ((8 & var16) != 8) {
        	 D_1 var88 = this;
            I_1 var91 = new I_1(var2);
            I_1 var92 = new I_1(var2);
            I_1 var93 = new I_1(var2);
            I_1 var94 = new I_1(var2);
            I_1 var95 = new I_1(var2);
            I_1 var96 = new I_1(var2);
            I_1 var97 = new I_1(var2);
         ...
         (var6 = new I_1(var5.a)).b = 0;
         (var7 = new I_1(var5.a)).b = var5.f;
         (var8 = new I_1(var5.a)).b = var5.g;
         (var9 = new I_1(var5.a)).b = var5.h;
         (var10 = new I_1(var5.a)).b = var5.i;
         int var11 = 0;
         var12 = 0;
         var13 = 0;
   ...
   public static void a(byte[] var0, int var1) {
      try {
         if (var0 == null) {
            ...
            I_1 var2;
            (var2 = new I_1(var0)).b = var0.length - 18;
            E_1 var12;
   ...
   private D_1(boolean var1) {
      this.I = true;
      this.w = false;
   }

   public D_1(int var1, D_1[] var2) {
      this.I = true;
      this.w = false;
      boolean var3 = false;
      boolean var4 = false;
   ...
   public D_1(boolean var1, boolean var2, boolean var3, D_1 var4) {
      this.I = true;
      this.w = false;
      this.b = var4.b;
      this.f = var4.f;
   ...
   public D_1(boolean var1, boolean var2, D_1 var3) {
      this.I = true;
      this.w = false;
      this.b = var3.b;
      this.f = var3.f;
   ...
   public final void a(D_1 var1, boolean var2) {
      this.b = var1.b;
      this.f = var1.f;
      this.T = var1.T;
      if (J.length < this.b) {
   ...
   private final int a(D_1 var1, int var2) {
      int var3 = -1;
   ...
   public final void a(int[] var1, int var2, int var3) {
      if (var3 != -1) {
         if (var1 != null && var2 != -1) {
            e var4;
            if ((var4 = uwotm8.e.a(var3)) != null) {
               e var9;
               if ((var9 = uwotm8.e.a(var2)) == null) {
                  this.c(var3);
               } else {
                  f var10 = var4.a;
                  au = 0;
   ...
   public final void a(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9) {
      ...
      if ((var13 = var11 + var12) > 50 && var11 < 3500) {
         int var14;
         int var15;
         if ((var15 = (var14 = var8 * var4 + var6 * var5 >> 16) - this.p << Client.l) / var13 < uwotm8.p.n) {
            int var16;
            if ((var16 = var14 + this.p << Client.l) / var13 > -uwotm8.p.n) {
               var10 = var7 * var3 - var10 * var2 >> 16;
               int var17 = this.p * var2 >> 16;
               int var18;
               if ((var18 = var10 + var17 << Client.l) / var13 > -uwotm8.p.o) {
                  var17 += super.aD * var3 >> 16;
                  if ((var17 = var10 - var17 << Client.l) / var13 < uwotm8.p.o) {
      ...
      for(var4 = 0; var4 < this.f; ++var4) {
         if (this.j == null || this.j[var4] != -1) {
            ...
            if (var1 && (var8 == -5000 || var9 == -5000 || var10 == -5000)) {
               ...
               ad[var4] = false;
               if (var8 >= 0 && var9 >= 0 && var10 >= 0 && var8 <= uwotm8.p.m && var9 <= uwotm8.p.m && var10 <= uwotm8.p.m) {
                  ac[var4] = false;
               } else {
                  ac[var4] = true;
               }
   ...
   private final void e(int var1) {
      if (ad[var1]) {
         ...
         if (var5 == 0) {
            uwotm8.r.a(af[var2], af[var3], af[var4], ae[var2], ae[var3], ae[var4], this.N[var1], this.O[var1], this.P[var1]);
         } else if (var5 == 1) {
            uwotm8.r.a(af[var2], af[var3], af[var4], ae[var2], ae[var3], ae[var4], ax[this.N[var1]]);
         } else {
            int var6;
            int var7;
            if (var5 == 2) {
               ...
               var7 = this.V[var5];
               var5 = this.W[var5];
               uwotm8.r.a(af[var2], af[var3], af[var4], ae[var2], ae[var3], ae[var4], this.N[var1], this.O[var1], this.P[var1], ah[var6], ah[var7], ah[var5], ai[var6], ai[var7], ai[var5], aj[var6], aj[var7], aj[var5], this.k[var1]);
            } else {
               if (var5 == 3) {
                  var5 = this.j[var1] >> 2;
                  var6 = this.U[var5];
                  var7 = this.V[var5];
                  var5 = this.W[var5];
                  uwotm8.r.a(af[var2], af[var3], af[var4], ae[var2], ae[var3], ae[var4], this.N[var1], this.N[var1], this.N[var1], ah[var6], ah[var7], ah[var5], ai[var6], ai[var7], ai[var5], aj[var6], aj[var7], aj[var5], this.k[var1]);
               }
   ...
   private final void f(int var1) {
      if (this.k == null || this.k[var1] != 65535) {
         ...
         if ((var11 - var12) * (var3 - var2) - (var14 - var2) * (var13 - var12) > 0) {
            uwotm8.r.b = false;
            if (var4 == 3) {
               if (var11 < 0 || var12 < 0 || var13 < 0 || var11 > uwotm8.p.m || var12 > uwotm8.p.m || var13 > uwotm8.p.m) {
                  uwotm8.r.b = true;
               }
               ...
               if (var5 == 0) {
                  uwotm8.r.a(var14, var2, var3, var11, var12, var13, at[0], at[1], at[2]);
               } else if (var5 == 1) {
                  uwotm8.r.a(var14, var2, var3, var11, var12, var13, ax[this.N[var1]]);
               } else if (var5 == 2) {
                  var5 = this.j[var1] >> 2;
                  var6 = this.U[var5];
                  var7 = this.V[var5];
                  var5 = this.W[var5];
                  uwotm8.r.a(var14, var2, var3, var11, var12, var13, at[0], at[1], at[2], ah[var6], ah[var7], ah[var5], ai[var6], ai[var7], ai[var5], aj[var6], aj[var7], aj[var5], this.k[var1]);
               } else if (var5 == 3) {
                  var5 = this.j[var1] >> 2;
                  var6 = this.U[var5];
                  var7 = this.V[var5];
                  var5 = this.W[var5];
                  uwotm8.r.a(var14, var2, var3, var11, var12, var13, this.N[var1], this.N[var1], this.N[var1], ah[var6], ah[var7], ah[var5], ai[var6], ai[var7], ai[var5], aj[var6], aj[var7], aj[var5], this.k[var1]);
               }
            }

            if (var4 == 4) {
               if (var11 < 0 || var12 < 0 || var13 < 0 || var11 > uwotm8.p.m || var12 > uwotm8.p.m || var13 > uwotm8.p.m || ar[3] < 0 || ar[3] > uwotm8.p.m) {
                  uwotm8.r.b = true;
               }
               ...
               if (var5 == 0) {
                  uwotm8.r.a(var14, var2, var3, var11, var12, var13, at[0], at[1], at[2]);
                  uwotm8.r.a(var14, var3, as[3], var11, var13, ar[3], at[0], at[2], at[3]);
                  return;
               }

               if (var5 == 1) {
                  var5 = ax[this.N[var1]];
                  uwotm8.r.a(var14, var2, var3, var11, var12, var13, var5);
                  uwotm8.r.a(var14, var3, as[3], var11, var13, ar[3], var5);
                  return;
               }
               ...
               if (var5 == 2) {
                  ...
                  var5 = this.W[var5];
                  uwotm8.r.a(var14, var2, var3, var11, var12, var13, at[0], at[1], at[2], ah[var6], ah[var7], ah[var5], ai[var6], ai[var7], ai[var5], aj[var6], aj[var7], aj[var5], this.k[var1]);
                  uwotm8.r.a(var14, var3, as[3], var11, var13, ar[3], at[0], at[2], at[3], ah[var6], ah[var7], ah[var5], ai[var6], ai[var7], ai[var5], aj[var6], aj[var7], aj[var5], this.k[var1]);
                  return;
               }
               ...
               if (var5 == 3) {
                  ...
                  var5 = this.W[var5];
                  uwotm8.r.a(var14, var2, var3, var11, var12, var13, this.N[var1], this.N[var1], this.N[var1], ah[var6], ah[var7], ah[var5], ai[var6], ai[var7], ai[var5], aj[var6], aj[var7], aj[var5], this.k[var1]);
                  uwotm8.r.a(var14, var3, as[3], var11, var13, ar[3], this.N[var1], this.N[var1], this.N[var1], ah[var6], ah[var7], ah[var5], ai[var6], ai[var7], ai[var5], aj[var6], aj[var7], aj[var5], this.k[var1]);
               }
            }
         }
