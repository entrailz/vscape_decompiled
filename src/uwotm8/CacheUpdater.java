...
public final class CacheUpdater
{
    ...
    public static int b() throws IOException {
        final File file = new File(String.valueOf(al.a()) + "cacheVersion.dat");
    ...
    private void a(final String s, final String s2) {
        ...
        try {
            ...
            outputStream = new BufferedOutputStream(new FileOutputStream(String.valueOf(al.a()) + s2));
        ...
        try {
            ...
            while ((nextEntry = zipInputStream.getNextEntry()) != null) {
                if (nextEntry.isDirectory()) {
                    new File(String.valueOf(al.a()) + nextEntry.getName()).mkdir();
                }
                else {
                    ...
                    a(zipInputStream, String.valueOf(al.a()) + nextEntry.getName());
                }
            }
