...
public class Actor extends Renderable
{
    ...
    public final void setPosition(final int n, final int n2, final boolean b) {
    ...
    public final void updateHits(final int n, final int n2, final int n3) {
        for (int i = 0; i < 4; ++i) {
            if (this.o[i] <= n3) {
                this.m[i] = n2;
                this.n[i] = n;
    ...
    public final void walk(final boolean b, int i) {
        int n = this.a[0];
        int n2 = this.b[0];
        if (i == 0) {
            --n;
