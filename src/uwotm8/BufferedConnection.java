...
public final class BufferedConnection implements Runnable
{
    ...
    private boolean d;
    private final com.runescape.ScapeApplet e;
    private byte[] f;
    private int g;
    private int h;
    private boolean i;
    ...
    public BufferedConnection(final com.runescape.ScapeApplet e, final Socket c) throws IOException {
        this.d = false;
        this.i = false;
        this.j = false;
        this.e = e;
    ...
    public final void flushInputStream(final byte[] array, int i) throws IOException {
        int n = 0;
        if (this.d) {
            return;
        }
