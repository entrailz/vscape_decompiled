...
public final class ItemDefinition {
   ...
   public int[] b;
   public int c = -1;
   public static Cache d = new Cache(100);
   public static Cache e = new Cache(50);
   public int[] f;
   public boolean g;
   private int z;
   public int h;
   ...
   private int D;
   public String k;
   private static ItemDefinition[] E;
   public int l;
   private int F;
   public int m;
   public boolean n;
   ...
   public static void init(Archive var0) {
      ...
      E = new ItemDefinition[10];

      for(var2 = 0; var2 < 10; ++var2) {
         E[var2] = new ItemDefinition();
      }
   ...
   public final boolean a(int var1) {
      ...
      if (var2 == -1) {
         ...
         boolean var5 = true;
         if (!uwotm8.Model.b(var2)) {
            var5 = false;
         }

         if (var3 != -1 && !uwotm8.Model.b(var3)) {
            var5 = false;
         }

         if (var4 != -1 && !uwotm8.Model.b(var4)) {
            var5 = false;
         }
   ...
   public final Model b(int var1) {
      ...
      if (var2 == -1) {
         ...
         Model var5 = uwotm8.Model.a(var2);
         if (var3 != -1) {
            Model var7;
            if (var4 != -1) {
               var7 = uwotm8.Model.a(var3);
               Model var8 = uwotm8.Model.a(var4);
   ...
   public static ItemDefinition c(int var0) {
   ...
   public static Sprite sprite(int var0, int var1, int var2) {
      ...
      if ((var20 = var19.getAmountModel(1)) == null) {
         ...
         if (var19.h != -1 && (var21 = sprite(var19.G, 10, -1)) == null) {
            ...
            int var18 = uwotm8.Rasterizer3D.r[var19.t] * var17 >> 16;
            var17 = uwotm8.Rasterizer3D.s[var19.t] * var17 >> 16;
   ...
   public final Model getAmountModel(int var1) {
      while(true) {
         ...
         if ((var4 = uwotm8.Model.a(this.F)) == null) {
            return null;
         }
