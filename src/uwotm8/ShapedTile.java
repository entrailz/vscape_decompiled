...
public final class ShapedTile
{
    ...
    public ShapedTile(int n, final int n2, final int n3, final int n4, final int n5, final int n6, final int m, final int n7, final int n8, final int n9, final int n10, final int n11, final int n12, final int l, final int n13, final int n14, final int n15, int n16, int length) {
        ...
        this.o = length;
        final int[] array;
        length = (array = ShapedTile.u[l]).length;
        ...
        final int[] array4;
        final int n23 = (array4 = ShapedTile.v[l]).length / 4;
        this.g = new int[n23];
        this.h = new int[n23];
        this.i = new int[n23];
        this.d = new int[n23];
