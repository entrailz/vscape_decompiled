...
public class b extends Applet implements FocusListener, KeyListener, MouseListener, MouseMotionListener, MouseWheelListener, WindowListener, Runnable
{
    private int a;
    private int b;
    int ak;
    ...
    public final void a(final boolean b, final int am, final int an, final boolean b2, final boolean b3) {
        ...
        (this.aq = new c(this, am, an, b2, b)).addWindowListener(this);
